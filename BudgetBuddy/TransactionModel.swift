...
struct accumulateTransaction: Identifiable {
    let id = UUID()
    let date: Date
    let amount: Double
...
extension Category {
    ...
    static let transafer = Category(id: 9, name: "Transfer", icon: .exchange_alt)
    ...
    static let moviesAndDVDs = Category(id: 301, name: "Movies & DVS", icon: .film, mainCategoryId: 3)
